...
- App icon across Android (adaptive), iOS, web, and Windows.

### Changed

- Windows release builds embed the OAuth desktop client, so distributed
  builds no longer require a local `credentials.json` — users just sign in.
...
[0.1.2]: https://github.com/kamal-nabhan/PageTether/releases/tag/v0.1.2
